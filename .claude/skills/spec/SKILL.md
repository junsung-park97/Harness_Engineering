...
The terminal state is invoking `writing-plans`. Do NOT invoke `frontend-design`, `mcp-builder`, or any other implementation skill. The ONLY skill you invoke after spec is `writing-plans`.
...
For deeper review, you may dispatch a spec document reviewer subagent using the template in `spec-document-reviewer-prompt.md`. This is optional — use it for high-stakes specs where independent verification adds value.
